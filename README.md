...
Review packs include an adapter summary, work-preview table, and scene-preview
table so reviewers can see the FFmpeg baseline used for rendered outputs and the
planned animation adapter boundaries.
...
review pack, and adapter summary.
