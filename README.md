...
- Checking [episode consumption and controlled scene reviews](docs/episode-delivery-v0.1.md):
  decoded frame/sample identity, D/M/E recombination, cut-boundary findings and
  dialogue-fixed A/B comparisons with no-score/full-mix listening variants.
