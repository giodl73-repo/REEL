...
source paths, source commits, styles, alternate styles, platform names, platform
counts, scene counts, shot counts, export counts, and manifest timing totals
before expensive artifact or review-pack generation.
