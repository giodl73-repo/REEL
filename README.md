...
schema versions, baseline adapter identities, and platform counts across works.
...
source manifest/artifact schema/baseline adapter/platform/video/image split
counts, plus video duration.
