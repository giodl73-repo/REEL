...
schema versions, baseline adapter identities, work ids, and platform counts
across works.
...
work id/source manifest/artifact schema/baseline adapter/platform/video/image
split counts, plus video duration.
