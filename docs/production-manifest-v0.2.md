...
REEL CLI v0.2.14 does not revise this contract. Smooth subpixel motion,
...
`caption-accessibility-v0.2.8.md`, and
`speaker-caption-presentation-v0.2.9.md`, `caption-layout-v0.2.10.md`, and
`audio-quality-v0.2.11.md`, `comparison-composer-v0.2.12.md`, and
`review-decisions-v0.2.13.md`, and `comparison-slate-layout-v0.2.14.md`.
